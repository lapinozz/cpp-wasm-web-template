...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getBool')) {
        Object.defineProperty(Module['ready'], '_getBool', { configurable: true, get: function() { abort('You are getting _getBool on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getBool', { configurable: true, set: function() { abort('You are setting _getBool on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getString')) {
        Object.defineProperty(Module['ready'], '_getString', { configurable: true, get: function() { abort('You are getting _getString on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getString', { configurable: true, set: function() { abort('You are setting _getString on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getInt')) {
        Object.defineProperty(Module['ready'], '_getInt', { configurable: true, get: function() { abort('You are getting _getInt on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getInt', { configurable: true, set: function() { abort('You are setting _getInt on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'client.wasm.wasm';
...
/** @type {function(...*):?} */
var _getBool = Module["_getBool"] = createExportWrapper("getBool");

/** @type {function(...*):?} */
var _getString = Module["_getString"] = createExportWrapper("getString");

/** @type {function(...*):?} */
var _getInt = Module["_getInt"] = createExportWrapper("getInt");
